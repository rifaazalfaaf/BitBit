            ...
            <div class="row">
                <div class="col-md-4">
                    <a href="#">
                        <div class="card">
                            <div class="container">
                                <img class="card-img-top" src="assets/img/tukangkebun.png" alt="Tukang Kebun" style="width:100%; margin-top:10px;margin-bottom: 20px; "><br>
            ...
            <div class="row">
                <div class="col-md-4">
                    <a href="#">
                        <div class="card">
                            <div class="container">
                                <img class="card-img-top" src="assets/img/tukangkebun.png"" alt="Arsitektur" style="width:100%; margin-top:10px;margin-bottom: 20px; "><br>
                                <span class="nama-produk">Sukiman Rivero</span><br>
                                <label class="alamat" for="alamat">Depok</label>
                                <div class="rating">
                                    <span class="fa fa-star checked"></span>
        ...
        <div class="card-produk">
            <div class="row">
                <div class="col-md-6">
                    <div class="card">
                        <div class="container">
                            <img class="card-img-top" src="assets/img/artikel.png" alt="Artikel" style="width:100%; margin-top:10px;margin-bottom: 20px; "><br>
